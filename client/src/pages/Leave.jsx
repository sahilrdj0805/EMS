...
import { PalmtreeIcon, PlusIcon, ThermometerIcon, UmbrellaIcon, SparklesIcon } from "lucide-react"
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        {!isAdmin && !isDeleted && (
          <div className="flex gap-2 w-full sm:w-auto">
            <button onClick={()=> setShowModal(true)} className="btn-primary flex items-center gap-2 flex-1 sm:flex-initial justify-center">
